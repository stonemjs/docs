...
<tr>
<td>Node CLI</td>
<td><code v-pre>IncomingEvent</code></td>
...
<p>Here are the core properties of an <code v-pre>IncomingEvent</code>:</p>
<table>
<thead>
<tr>
<th>Property</th>
...
<td>The immutable type of the incoming event <code v-pre>stonejs@incoming_event</code>.</td>
</tr>
<tr>
<td><code v-pre>locale</code></td>
<td>The preferred locale for the event (default is <code v-pre>'en'</code>).</td>
</tr>
<tr>
<td><code v-pre>metadata</code></td>
<td>Internal metadata, modifiable via <code v-pre>get()</code> and <code v-pre>set()</code> methods.</td>
</tr>
<tr>
<td><code v-pre>source</code></td>
<td>A structured object representing the original external context.</td>
</tr>
<tr>
<td><code v-pre>timeStamp</code></td>
<td>The time when the event was created (milliseconds since epoch).</td>
</tr>
</tbody>
</table>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>You’ll typically use it for:</p>
<ul>
<li>Debugging and introspection</li>
<li>Logging raw platform-level input</li>
<li>Implementing lower-level integrations or fallbacks</li>
</ul>
<h4 id="example-accessing-raw-aws-lambda-input" tabindex="-1"><a class="header-anchor" href="#example-accessing-raw-aws-lambda-input"><span>Example: Accessing raw AWS Lambda input</span></a></h4>
<div class="language-typescript line-numbers-mode" data-highlighter="prismjs" data-ext="ts"><pre v-pre><code><span class="line">event<span class="token punctuation">.</span>source<span class="token punctuation">.</span>platform <span class="token comment">// 'aws_lambda'</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>This structure is consistent across platforms, making it easier to write adapter-agnostic fallback logic when necessary.</p>
<div class="hint-container important">
<p class="hint-container-title">Important</p>
<p>That said, <strong>avoid relying too heavily on the source</strong>. If you find yourself accessing <code v-pre>rawEvent</code> often,
...
<li><strong>Dot notation</strong> is supported for accessing or adding nested values (<code v-pre>user.name</code>, <code v-pre>user.role</code>, etc.)</li>
<li>You can provide a <strong>fallback value</strong> if the key is not found:</li>
</ul>
<div class="language-typescript line-numbers-mode" data-highlighter="prismjs" data-ext="ts"><pre v-pre><code><span class="line">event<span class="token punctuation">.</span><span class="token function">get</span><span class="token punctuation">(</span><span class="token string">'permissions.admin'</span><span class="token punctuation">,</span> <span class="token boolean">false</span><span class="token punctuation">)</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><ul>
<li>You can also add internal data using <code v-pre>set()</code>:</li>
</ul>
...
<p>That means you can use <code v-pre>event.get('payload.message')</code> in both environments:</p>
<ul>
<li>In local development with the HTTP adapter and Postman (where the payload is in the body)</li>
<li>In Lambda (where the payload might be buried inside the raw <code v-pre>event</code> object)</li>
</ul>
<div class="language-typescript line-numbers-mode" data-highlighter="prismjs" data-ext="ts"><pre v-pre><code><span class="line"><span class="token comment">// Works in both environments!</span></span>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Once passed to your handler, you should treat it as <strong>read-only</strong>, except for setting metadata via <code v-pre>set()</code>. If you need to duplicate or fork the event, use <code v-pre>clone()</code>.</p>
<div class="language-typescript line-numbers-mode" data-highlighter="prismjs" data-ext="ts"><pre v-pre><code><span class="line"><span class="token keyword">const</span> copy <span class="token operator">=</span> event<span class="token punctuation">.</span><span class="token function">clone</span><span class="token punctuation">(</span><span class="token punctuation">)</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="using-incomingbrowserevent" tabindex="-1"><a class="header-anchor" href="#using-incomingbrowserevent"><span>Using IncomingBrowserEvent</span></a></h2>
<p>The <code v-pre>IncomingBrowserEvent</code> is a platform-specific subclass of <code v-pre>IncomingEvent</code>, designed for applications running in a <strong>browser context</strong>. It is automatically created by adapters like <code v-pre>@stone-js/browser-adapter</code> and provides extended APIs tailored for frontend navigation, SPA routing, cookies, and client environment detection.</p>
<p>It includes all capabilities of <code v-pre>IncomingEvent</code> (e.g., <code v-pre>get()</code>, <code v-pre>set()</code>, <code v-pre>clone()</code>, metadata, source access), but adds features specific to browser-based use cases.</p>
<h3 id="constructor-reference" tabindex="-1"><a class="header-anchor" href="#constructor-reference"><span>Constructor Reference</span></a></h3>
<table>
<thead>
<tr>
<th>Property</th>
...
<td><code v-pre>URL</code></td>
<td>Required. The browser's full URL</td>
</tr>
<tr>
<td><code v-pre>protocol</code></td>
<td><code v-pre>string</code></td>
<td>Optional. The connection protocol (default: <code v-pre>'http'</code>)</td>
</tr>
<tr>
<td><code v-pre>queryString</code></td>
<td><code v-pre>string</code></td>
<td>Optional. Raw query string (parsed internally into <code v-pre>query</code>)</td>
</tr>
<tr>
<td><code v-pre>cookies</code></td>
<td><code v-pre>CookieCollection</code></td>
<td>Optional. Pre-parsed cookies</td>
</tr>
<tr>
<td><code v-pre>source</code></td>
<td><code v-pre>IncomingEventSource</code></td>
<td>Required. Raw external context (e.g., window/document events)</td>
</tr>
<tr>
<td><code v-pre>locale</code></td>
<td><code v-pre>string</code></td>
<td>Optional. Locale string (default: <code v-pre>'en'</code>)</td>
</tr>
<tr>
<td><code v-pre>metadata</code></td>
<td><code v-pre>Record&lt;string, unknown&gt;</code></td>
<td>Optional. Initial metadata for internal state</td>
</tr>
</tbody>
</table>
...
<tbody>
<tr>
<td><code v-pre>'popstate'</code></td>
<td>User navigates using browser history (e.g., back/forward)</td>
</tr>
<tr>
<td><code v-pre>'@stonejs/router.navigate'</code></td>
<td>Programmatic navigation via the Stone.js Router</td>
</tr>
</tbody>
</table>
<p>For example:</p>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><p>Stone.js will start listening to <code v-pre>'my-custom-event'</code>, and whenever it is dispatched, it will be converted into an <code v-pre>IncomingBrowserEvent</code>.</p>
<div class="hint-container tip">
<p class="hint-container-title">But honestly?</p>
...
The declarative API is used for demonstration purposes, but you can also use the imperative API.</p>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>As highlighted, the <code v-pre>IncomingBrowserEvent</code> is not instantiated directly. Instead, you configure it using the <code v-pre>incomingEventBuilder</code>, which allows you to define the properties listed above before the incoming event is passed to the <a href="./event-handler">event handler</a>.</p>
<h3 id="url-and-query-access" tabindex="-1"><a class="header-anchor" href="#url-and-query-access"><span>URL and Query Access</span></a></h3>
<p>Browser events are centered around the current document's URL. <code v-pre>IncomingBrowserEvent</code> provides direct access to the key parts of the URL via:</p>
<ul>
<li><code v-pre>event.uri</code> → full URL string</li>
<li><code v-pre>event.path</code> → <code v-pre>pathname + search</code></li>
<li><code v-pre>event.pathname</code> → URL path without query</li>
<li><code v-pre>event.query</code> → <code v-pre>URLSearchParams</code> instance</li>
<li><code v-pre>event.queryString</code> → raw query string</li>
<li><code v-pre>event.host</code>, <code v-pre>event.hostname</code>, <code v-pre>event.hash</code>, <code v-pre>event.scheme</code></li>
</ul>
<p>And useful helpers like:</p>
<div class="language-typescript line-numbers-mode" data-highlighter="prismjs" data-ext="ts"><pre v-pre><code><span class="line">event<span class="token punctuation">.</span>decodedPathname <span class="token comment">// decoded version of pathname</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>These utilities are useful for dynamic rendering, navigation guards, and routing logic in SPAs.</p>
<h3 id="cookies-and-query-parameters" tabindex="-1"><a class="header-anchor" href="#cookies-and-query-parameters"><span>Cookies and Query Parameters</span></a></h3>
<p>The browser event provides full cookie support using the <code v-pre>CookieCollection</code> utility:</p>
<div class="language-typescript line-numbers-mode" data-highlighter="prismjs" data-ext="ts"><pre v-pre><code><span class="line">event<span class="token punctuation">.</span><span class="token function">getCookie</span><span class="token punctuation">(</span><span class="token string">'auth_token'</span><span class="token punctuation">,</span> <span class="token punctuation">{</span><span class="token punctuation">}</span><span class="token punctuation">)</span> <span class="token comment">// Return a Cookie object or default value</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>You can also read cookie values directly using <code v-pre>event.get()</code> thanks to the smart accessor API.</p>
<p>Likewise, <code v-pre>event.query.get('page')</code> or <code v-pre>event.get('page')</code> will fetch query parameters.</p>
<h3 id="routing-integration" tabindex="-1"><a class="header-anchor" href="#routing-integration"><span>Routing Integration</span></a></h3>
<p>The <code v-pre>IncomingBrowserEvent</code> supports route integration via internal route resolvers:</p>
<div class="hint-container important">
<p class="hint-container-title">Important</p>
<p>This API is only available when the router is active. If you’re not using the router, these methods will return <code v-pre>undefined</code>.</p>
</div>
<div class="language-typescript line-numbers-mode" data-highlighter="prismjs" data-ext="ts"><pre v-pre><code><span class="line">event<span class="token punctuation">.</span><span class="token function">getRoute</span><span class="token punctuation">(</span><span class="token punctuation">)</span>      <span class="token comment">// Current matched route (if any)</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>This allows you to access dynamic route parameters directly from the incoming event, making it easy to build SPAs with Stone.js.</p>
<h3 id="user-environment-detection" tabindex="-1"><a class="header-anchor" href="#user-environment-detection"><span>User Environment Detection</span></a></h3>
<p>You can safely introspect the browser’s environment using:</p>
<div class="language-typescript line-numbers-mode" data-highlighter="prismjs" data-ext="ts"><pre v-pre><code><span class="line">event<span class="token punctuation">.</span>userAgent  <span class="token comment">// Returns navigator.userAgent</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="smart-get-strategy" tabindex="-1"><a class="header-anchor" href="#smart-get-strategy"><span>Smart <code v-pre>get()</code> Strategy</span></a></h3>
<p><code v-pre>IncomingBrowserEvent</code> inherits the smart accessor from <code v-pre>IncomingEvent</code>, but overrides its lookup order to favor browser-specific sources:</p>
<ol>
<li>Route parameters (If using the router)</li>
<li>Query parameters</li>
<li>Cookies</li>
<li>Metadata</li>
</ol>
<p>This means that in browser applications, calling:</p>
<div class="language-typescript line-numbers-mode" data-highlighter="prismjs" data-ext="ts"><pre v-pre><code><span class="line">event<span class="token punctuation">.</span><span class="token function">get</span><span class="token punctuation">(</span><span class="token string">'theme'</span><span class="token punctuation">,</span> <span class="token string">'light'</span><span class="token punctuation">)</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><p>Will try to find <code v-pre>theme</code> from:</p>
<ul>
<li>A dynamic route segment (e.g., <code v-pre>/theme/:theme</code>)</li>
<li>A query string like <code v-pre>?theme=dark</code></li>
<li>A cookie like <code v-pre>theme=dark</code></li>
...
<p><code v-pre>IncomingHttpEvent</code> is the most advanced subclass of <code v-pre>IncomingEvent</code>. It is created automatically by HTTP-compatible adapters such as:</p>
<ul>
<li><code v-pre>@stone-js/node-http-adapter</code> (Node.js HTTP/HTTPS server)</li>
...
<td><code v-pre>url</code></td>
<td><code v-pre>URL</code></td>
<td>Required. The full request URL</td>
</tr>
<tr>
<td><code v-pre>ip</code></td>
<td><code v-pre>string</code></td>
<td>Required. The client’s IP address</td>
</tr>
<tr>
<td><code v-pre>ips</code></td>
<td><code v-pre>string[]</code></td>
<td>Optional. Proxy IP chain if available</td>
</tr>
<tr>
<td><code v-pre>method</code></td>
<td><code v-pre>HttpMethod</code></td>
<td>Optional. The HTTP method (default: <code v-pre>'GET'</code>)</td>
</tr>
<tr>
<td><code v-pre>headers</code></td>
<td><code v-pre>Headers</code> or <code v-pre>Record&lt;string,string&gt;</code></td>
<td>Optional. Parsed request headers</td>
</tr>
<tr>
<td><code v-pre>body</code></td>
<td><code v-pre>Record&lt;string, unknown&gt;</code></td>
<td>Optional. Parsed request body</td>
</tr>
<tr>
<td><code v-pre>files</code></td>
<td><code v-pre>Record&lt;string, UploadedFile[]&gt;</code></td>
<td>Optional. Uploaded files (if any)</td>
</tr>
<tr>
<td><code v-pre>queryString</code></td>
<td><code v-pre>string</code></td>
<td>Optional. Raw query string</td>
</tr>
<tr>
<td><code v-pre>cookies</code></td>
<td><code v-pre>CookieCollection</code></td>
<td>Optional. Parsed cookies</td>
</tr>
<tr>
<td><code v-pre>source</code></td>
<td><code v-pre>IncomingEventSource</code></td>
<td>Required. Raw request data from the adapter</td>
</tr>
<tr>
<td><code v-pre>locale</code></td>
<td><code v-pre>string</code></td>
<td>Optional. The preferred locale (default: <code v-pre>'en'</code>)</td>
</tr>
<tr>
<td><code v-pre>metadata</code></td>
<td><code v-pre>Record&lt;string, unknown&gt;</code></td>
<td>Optional. Initial internal metadata</td>
</tr>
</tbody>
</table>
<p>You will never manually instantiate this event. It is built by the adapter and passed to your event handler automatically.</p>
<div class="hint-container tip">
<p class="hint-container-title">Don't forget!</p>
<p>You can participate in the creation process using <a href="../architecture/adapter#adapter-middleware">adapter middleware</a>.</p>
</div>
<h3 id="url-method-and-routing-access" tabindex="-1"><a class="header-anchor" href="#url-method-and-routing-access"><span>URL, Method, and Routing Access</span></a></h3>
<p>Just like <code v-pre>IncomingBrowserEvent</code>, you can retrieve and manipulate URL-related information.</p>
<p>For example, consider this URL: <code v-pre>http://user:pass@site.com:80/pa/th?q=val#hash</code>, represented by this image:</p>
<figure><img src="/assets/image/url_components.png" alt="URL components" tabindex="0" loading="lazy"><figcaption>URL components</figcaption></figure>
<p>Here’s how to access this URL and its components:</p>
<div class="language-typescript line-numbers-mode" data-highlighter="prismjs" data-ext="ts"><pre v-pre><code><span class="line">event<span class="token punctuation">.</span>url <span class="token comment">// returns the full URL</span></span>
...
<div class="language-typescript line-numbers-mode" data-highlighter="prismjs" data-ext="ts"><pre v-pre><code><span class="line"><span class="token comment">// Get HTTP method</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Route information is also accessible if you’re using the Stone.js Router:</p>
<div class="language-typescript line-numbers-mode" data-highlighter="prismjs" data-ext="ts"><pre v-pre><code><span class="line">event<span class="token punctuation">.</span>params         <span class="token comment">// returns an object with all route parameters</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="headers-and-content-negotiation" tabindex="-1"><a class="header-anchor" href="#headers-and-content-negotiation"><span>Headers and Content Negotiation</span></a></h3>
<p>The <code v-pre>IncomingHttpEvent</code> exposes full control over headers via:</p>
<div class="language-typescript line-numbers-mode" data-highlighter="prismjs" data-ext="ts"><pre v-pre><code><span class="line"><span class="token comment">// Get headers</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>It also handles content negotiation through:</p>
<div class="language-typescript line-numbers-mode" data-highlighter="prismjs" data-ext="ts"><pre v-pre><code><span class="line">event<span class="token punctuation">.</span>types     <span class="token comment">// Acceptable types</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="request-body-and-json" tabindex="-1"><a class="header-anchor" href="#request-body-and-json"><span>Request Body and JSON</span></a></h3>
<p>For HTTP requests that include a body, you can access and inspect it through:</p>
<div class="language-typescript line-numbers-mode" data-highlighter="prismjs" data-ext="ts"><pre v-pre><code><span class="line">event<span class="token punctuation">.</span>body                         <span class="token comment">// the full parsed body</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>This enables safe and expressive handling of incoming data, especially for APIs receiving structured JSON payloads.</p>
<h3 id="file-uploads" tabindex="-1"><a class="header-anchor" href="#file-uploads"><span>File Uploads</span></a></h3>
<p>If your adapter supports multipart/form-data, uploaded files are accessible via:</p>
<div class="language-typescript line-numbers-mode" data-highlighter="prismjs" data-ext="ts"><pre v-pre><code><span class="line">event<span class="token punctuation">.</span>files <span class="token comment">// returns all uploaded files Record&lt;string, UploadedFile[]></span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>You can filter uploaded files:</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code><span class="line"><span class="token comment">// Get filtered uploaded files</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Each <code v-pre>UploadedFile</code> provides utilities:</p>
<div class="language-typescript line-numbers-mode" data-highlighter="prismjs" data-ext="ts"><pre v-pre><code><span class="line">file<span class="token punctuation">.</span><span class="token function">isValid</span><span class="token punctuation">(</span><span class="token punctuation">)</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>You can save a file using the <code v-pre>move</code> method, which takes the relative path of the directory where the file will be saved as a mandatory parameter and an optional parameter to specify the name used for saving the file:</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code><span class="line"><span class="token comment">// Get the first valid file</span></span>
...
<h3 id="enabling-body-and-file-uploads" tabindex="-1"><a class="header-anchor" href="#enabling-body-and-file-uploads"><span>Enabling Body and File Uploads</span></a></h3>
<p>Stone.js is designed to be fast and lightweight by default. To keep bundle size and boot time minimal, <strong>body parsing and file upload handling are opt-in features</strong>, not included unless explicitly added.</p>
<p>To access:</p>
<ul>
<li><code v-pre>event.body</code></li>
<li><code v-pre>event.files</code></li>
<li><code v-pre>event.json()</code></li>
<li><code v-pre>event.getFile()</code></li>
</ul>
<p>You must register the corresponding middleware:</p>
<table>
<thead>
<tr>
...
<tbody>
<tr>
<td><code v-pre>BodyEventMiddleware</code></td>
<td>Parses the incoming request body into <code v-pre>event.body</code></td>
</tr>
<tr>
<td><code v-pre>FilesEventMiddleware</code></td>
<td>Parses uploaded files into <code v-pre>event.files</code> and helpers</td>
</tr>
</tbody>
</table>
<p>These middleware are shipped in each HTTP adapter but <strong>are not installed by default</strong>. You must explicitly register them using the blueprint.</p>
<p>Each adapter provides its <strong>own compatible middleware</strong>, so you must only use middleware from the adapter you're working with.</p>
<h4 id="example-registering-with-node-http-adapter" tabindex="-1"><a class="header-anchor" href="#example-registering-with-node-http-adapter"><span>Example: Registering with Node HTTP Adapter</span></a></h4>
<p>Here is a declative and imperative example of how to register the body and file upload middleware with the Node HTTP adapter.</p>
<Tabs id="958" :data='[{"id":"Declarative"},{"id":"Imperative"}]' :active="0" tab-id="declarative-imperative">
<template #title0="{ value, isActive }">Declarative</template>
<template #title1="{ value, isActive }">Imperative</template>
<template #tab0="{ value, isActive }">
<h5 id="declarative-registration" tabindex="-1"><a class="header-anchor" href="#declarative-registration"><span>Declarative registration</span></a></h5>
<p>To register the middleware declaratively, use the <code v-pre>middleware</code> option within the <code v-pre>@NodeHttp()</code> decorator. This approach allows you to specify the middleware directly in the adapter configuration, ensuring a clean and concise setup.</p>
<div class="language-typescript line-numbers-mode" data-highlighter="prismjs" data-ext="ts"><pre v-pre><code><span class="line"><span class="token keyword">import</span> <span class="token punctuation">{</span></span>
<span class="line">  NodeHttp<span class="token punctuation">,</span> BodyEventMiddleware<span class="token punctuation">,</span> FilesEventMiddleware</span>
...
<span class="line">    BodyEventMiddleware<span class="token punctuation">,</span></span>
<span class="line">    FilesEventMiddleware</span>
<span class="line">  <span class="token punctuation">]</span></span>
...
<h5 id="imperative-registration" tabindex="-1"><a class="header-anchor" href="#imperative-registration"><span>Imperative registration</span></a></h5>
<p>To register the middleware imperatively, you can use the <code v-pre>defineAdapterMiddleware()</code> function.</p>
<div class="language-typescript line-numbers-mode" data-highlighter="prismjs" data-ext="ts"><pre v-pre><code><span class="line"><span class="token keyword">import</span> <span class="token punctuation">{</span></span>
<span class="line">  BodyEventMiddleware<span class="token punctuation">,</span> FilesEventMiddleware</span>
<span class="line"><span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'@stone-js/node-http-adapter'</span></span>
<span class="line"><span class="token keyword">import</span> <span class="token punctuation">{</span></span>
<span class="line">  defineBlueprintConfig<span class="token punctuation">,</span> defineAdapterMiddleware</span>
...
<span class="line"></span>
<span class="line"><span class="token keyword">export</span> <span class="token keyword">const</span> mainBlueprint <span class="token operator">=</span> <span class="token function">defineBlueprintConfig</span><span class="token punctuation">(</span><span class="token punctuation">{</span></span>
<span class="line">  <span class="token function">afterConfigure</span><span class="token punctuation">(</span>blueprint<span class="token punctuation">)</span> <span class="token punctuation">{</span></span>
...
<span class="line">      <span class="token function">defineAdapterMiddleware</span><span class="token punctuation">(</span><span class="token punctuation">[</span>BodyEventMiddleware<span class="token punctuation">,</span> FilesEventMiddleware<span class="token punctuation">]</span><span class="token punctuation">)</span></span>
<span class="line">    <span class="token punctuation">)</span></span>
<span class="line">  <span class="token punctuation">}</span></span>
<span class="line"><span class="token punctuation">}</span><span class="token punctuation">)</span></span>
<span class="line"></span></code></pre>
...
<ul>
<li><strong>Fingerprinting</strong>: generate a unique hash for this request</li>
</ul>
<div class="language-typescript line-numbers-mode" data-highlighter="prismjs" data-ext="ts"><pre v-pre><code><span class="line">event<span class="token punctuation">.</span><span class="token function">fingerprint</span><span class="token punctuation">(</span><span class="token punctuation">)</span>       <span class="token comment">// uses method + path</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div></div></div><ul>
<li><strong>Caching Support</strong>:</li>
</ul>
<div class="language-typescript line-numbers-mode" data-highlighter="prismjs" data-ext="ts"><pre v-pre><code><span class="line">event<span class="token punctuation">.</span><span class="token function">isFresh</span><span class="token punctuation">(</span>response<span class="token punctuation">)</span>  <span class="token comment">// check cache freshness</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div></div></div><ul>
<li><strong>Range Requests</strong>:</li>
</ul>
<div class="language-typescript line-numbers-mode" data-highlighter="prismjs" data-ext="ts"><pre v-pre><code><span class="line">event<span class="token punctuation">.</span><span class="token function">range</span><span class="token punctuation">(</span><span class="token number">1024</span><span class="token punctuation">)</span>        <span class="token comment">// parses range header</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><ul>
<li><strong>Content Type Detection</strong>:</li>
</ul>
<div class="language-typescript line-numbers-mode" data-highlighter="prismjs" data-ext="ts"><pre v-pre><code><span class="line">event<span class="token punctuation">.</span><span class="token keyword">is</span><span class="token punctuation">(</span><span class="token string">'json'</span><span class="token punctuation">,</span> <span class="token string">'html'</span><span class="token punctuation">)</span>   <span class="token comment">// checks against content-type</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="cookie-access" tabindex="-1"><a class="header-anchor" href="#cookie-access"><span>Cookie Access</span></a></h3>
<p>The cookie API is consistent with <code v-pre>IncomingBrowserEvent</code>, and follows the <strong>continuum cookie contract</strong>. Stone.js guarantees that the <strong>same cookie access and mutation logic</strong> works identically across both client and server.</p>
<div class="language-typescript line-numbers-mode" data-highlighter="prismjs" data-ext="ts"><pre v-pre><code><span class="line">event<span class="token punctuation">.</span><span class="token function">getCookie</span><span class="token punctuation">(</span><span class="token string">'auth_token'</span><span class="token punctuation">,</span> <span class="token punctuation">{</span><span class="token punctuation">}</span><span class="token punctuation">)</span> <span class="token comment">// Return a Cookie object or default value</span></span>
<span class="line">event<span class="token punctuation">.</span>cookies<span class="token punctuation">.</span><span class="token function">getValue</span><span class="token punctuation">(</span><span class="token string">'auth_token'</span><span class="token punctuation">)</span> <span class="token comment">// Get the cookie value directly</span></span>
<span class="line">event<span class="token punctuation">.</span><span class="token function">hasCookie</span><span class="token punctuation">(</span><span class="token string">'isLoggedIn'</span><span class="token punctuation">)</span></span>
<span class="line"></span></code></pre>
...
<p>The <code v-pre>get()</code> method checks each of the following in order:</p>
<ol>
...
<p>This makes it incredibly flexible and consistent. For example:</p>
<div class="language-typescript line-numbers-mode" data-highlighter="prismjs" data-ext="ts"><pre v-pre><code><span class="line">event<span class="token punctuation">.</span><span class="token function">get</span><span class="token punctuation">(</span><span class="token string">'userId'</span><span class="token punctuation">)</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><p>Works whether:</p>
<ul>
<li>You passed it as a URL param (<code v-pre>/user/:userId</code>)</li>
<li>In the body of a POST request</li>
<li>As a query param (<code v-pre>?userId=123</code>)</li>
<li>In a custom header</li>
<li>Even as a cookie</li>
<li>Or in the metadata store</li>
<li>And as a fallback value</li>
</ul>
<p>Write your logic once. It works everywhere.</p>
<h3 id="other-utilities" tabindex="-1"><a class="header-anchor" href="#other-utilities"><span>Other Utilities</span></a></h3>
<p>Other useful getters to retrieve and inspect HTTP elements:</p>
<ul>
<li><code v-pre>event.ip</code>: The IP address</li>
<li><code v-pre>event.ips</code>: The IP addresses</li>
<li><code v-pre>event.isSecure</code>: Checks if the request is secure (<code v-pre>https</code>)</li>
<li><code v-pre>event.isXhr</code> / <code v-pre>event.isAjax</code>: Checks if the request is an <code v-pre>XMLHttpRequest</code></li>
<li><code v-pre>event.userAgent</code>: The user agent</li>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Use <code v-pre>'*'</code> to allow all proxies (or block all, depending on your needs):</p>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><h4 id="body-configuration" tabindex="-1"><a class="header-anchor" href="#body-configuration"><span>Body Configuration</span></a></h4>
<p>To limit memory usage and attack vectors, Stone.js lets you define strict limits on request bodies:</p>
...
<span class="line"><span class="token punctuation">}</span><span class="token punctuation">)</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>This config ensures the adapter knows how much data to read, how to decode it, and what to assume when no content-type is set.</p>
<h4 id="file-upload-configuration" tabindex="-1"><a class="header-anchor" href="#file-upload-configuration"><span>File Upload Configuration</span></a></h4>
<p>Stone.js uses <a href="https://github.com/mscdex/busboy" target="_blank" rel="noopener noreferrer"><code v-pre>busboy</code></a> internally to parse multipart/form-data uploads. You can customize <code v-pre>busboy</code> options directly via:</p>
...
<span class="line"><span class="token punctuation">}</span><span class="token punctuation">)</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>See the <a href="https://github.com/mscdex/busboy#busboy-methods" target="_blank" rel="noopener noreferrer">busboy documentation</a> for a full list of available options.</p>
<p>This allows you to control:</p>
<ul>
<li>Maximum file sizes</li>
<li>Number of files</li>
<li>Buffer size</li>
<li>Accepted MIME types (via file extension config, see below)</li>
</ul>
<h4 id="other-notable-options" tabindex="-1"><a class="header-anchor" href="#other-notable-options"><span>Other Notable Options</span></a></h4>
<table>
<thead>
<tr>
<th>Namespace</th>
...
<tbody>
<tr>
<td><code v-pre>stone.http.hosts.trusted</code></td>
<td>List of valid hostnames</td>
</tr>
<tr>
<td><code v-pre>stone.http.hosts.trustedPattern</code></td>
<td>Regex-like patterns for valid hosts</td>
</tr>
<tr>
<td><code v-pre>stone.http.subdomain.offset</code></td>
<td>Position to parse subdomains from hostname</td>
</tr>
</tbody>
</table>
...
<p>Stone.js comes with carefully chosen defaults that suit most applications, while still allowing you to customize settings when specific needs arise.</p>
</div>
<h2 id="best-practices" tabindex="-1"><a class="header-anchor" href="#best-practices"><span>Best Practices</span></a></h2>
<p>The <code v-pre>IncomingEvent</code> and its platform-specific subclasses are at the heart of every Stone.js application. They represent the user’s intention, and everything else in your app is just a reaction.</p>
<p>Here’s how to use them wisely.</p>
<h4 id="never-access-incomingevent-in-constructor-injection" tabindex="-1"><a class="header-anchor" href="#never-access-incomingevent-in-constructor-injection"><span>Never Access IncomingEvent in Constructor-Injection</span></a></h4>
<p>The <code v-pre>IncomingEvent</code> does <strong>not</strong> exist during system boot. It is only created during runtime, <strong>after the adapter has received an external cause</strong> and <code v-pre>onHandlingEvent</code> hooks have been triggered.</p>
<p>Trying to access the event in a constructor-injected service will cause hard-to-debug issues:</p>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>Instead</strong>: access the event in methods called at runtime, like inside your handler, middleware, or lifecycle hooks.</p>
<h4 id="prefer-get-over-manual-inspection" tabindex="-1"><a class="header-anchor" href="#prefer-get-over-manual-inspection"><span>Prefer <code v-pre>get()</code> Over Manual Inspection</span></a></h4>
<p>Avoid branching logic like this:</p>
<div class="language-typescript line-numbers-mode" data-highlighter="prismjs" data-ext="ts"><pre v-pre><code><span class="line"><span class="token keyword">if</span> <span class="token punctuation">(</span>event <span class="token keyword">instanceof</span> <span class="token class-name">IncomingHttpEvent</span><span class="token punctuation">)</span> <span class="token punctuation">{</span></span>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Just use the smart <code v-pre>get()</code>:</p>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><p>It handles the lookup strategy internally and gives you consistent results, even across environments like Lambda, Node, CLI, and browser.</p>
<h4 id="don-t-overuse-event-source" tabindex="-1"><a class="header-anchor" href="#don-t-overuse-event-source"><span>Don’t Overuse <code v-pre>event.source</code></span></a></h4>
<p>While <code v-pre>source.rawEvent</code> and <code v-pre>source.platform</code> are useful for introspection and debugging, avoid hard-coding platform-specific behavior in your logic:</p>
<div class="language-typescript line-numbers-mode" data-highlighter="prismjs" data-ext="ts"><pre v-pre><code><span class="line"><span class="token keyword">if</span> <span class="token punctuation">(</span>event<span class="token punctuation">.</span>source<span class="token punctuation">.</span>platform <span class="token operator">===</span> <span class="token string">'aws_lambda'</span><span class="token punctuation">)</span> <span class="token punctuation">{</span></span>
<span class="line">  <span class="token comment">// ❌ This defeats the platform-agnostic design</span></span>
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>If you need data from <code v-pre>rawEvent</code>, extract it with a middleware and inject it into <code v-pre>metadata</code> instead. That way your handlers remain clean and reusable.</p>
<h4 id="use-middleware-to-enrich-not-mutate" tabindex="-1"><a class="header-anchor" href="#use-middleware-to-enrich-not-mutate"><span>Use Middleware to Enrich, Not Mutate</span></a></h4>
...
<ul>
<li><code v-pre>IncomingEvent</code>: Generic, metadata-based, used for CLI, Lambda, lightweight adapters.</li>
...
<ul>
<li><code v-pre>get()</code>, <code v-pre>set()</code>, <code v-pre>clone()</code></li>
