...
Most of the time, route parameters are used to fetch models from a database or external API.

With **route model binding**, Stone Router can handle this for you, automatically resolving models and injecting them into your route handlers.
