...
If you're using TypeScript, create a `tsconfig.json` file and configure it to support decorators and JSX (for frontend apps). You can look at [Stone.js starter templates](https://github.com/stone-js/starters) for inspiration.
