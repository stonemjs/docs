...
`HTTP Core` is available from the [npm registry](https://www.npmjs.com) and can be installed as follows:
...
The `HTTP Core` module can only be imported via ESM import syntax:
